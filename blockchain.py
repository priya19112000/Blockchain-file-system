...
class Blockchain:
    ...
    def __init__(self):
        ...
        # self.sender = [] ###########
        # self.receiver = [] ##########
        self.create_block(proof = 1, previous_hash = '0' , sender = 'N.A' , file_hash = 'N.A') ##########
        self.nodes = set()
        self.nodes.add("127.0.0.1:5111")
    
    def create_block(self, proof, previous_hash, sender, file_hash):
    ...
    def add_file(self, sender, file_hash):
        ...
        self.create_block(proof, previous_hash, sender, file_hash)
        return index
